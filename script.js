// Close menu when clicking a nav link on mobile
    ...
    // Add a click event to close menu when clicking anywhere on the screen
    ...
    // Allow menu icon to toggle the menu without being closed by the document click
    if (openMenu) {
    ...
    if (inquiryForm) {
        ...
        if (window.location.search.includes('success=true')) {
            ...
            if (contactSection) {
                ...
                if (contactContent) {
                    contactContent.insertBefore(successMessage, document.querySelector('.contact-form'));
                }
    ...
    function animateOnScroll() {
        const elements = document.querySelectorAll('.course-card, .expertise-card, .about-content, .contact-content');
    ...
    document.querySelectorAll('.course-card, .expertise-card, .about-content, .contact-content').forEach(element => {
